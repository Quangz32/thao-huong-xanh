const productDetails = [
  {
    ...
    note: [
      "- Xà bông cần được bảo quản nơi khô thoáng, tánh ánh nắng trực tiếp, tốt nhất nên bảo quản ở nơi khô ráo, nhiệt độ 20-30 độ C. ",
...

  {
    ...
    intro: {
      //Phần được in đậm
      firstPart: "Xà bông dược liệu Nghệ",
      secondPart:
        " là sản phẩm xà bông tắm chiết xuất nghệ giúp giảm mụn, hạn chế oxy hóa, chứa các thành phần như dầu dừa, dầu oliu giúp làm sạch da, cung cấp độ ẩm. Sản phẩm chứa các thành phần tự nhiên không gây hại cho sức khỏe.",
    },
    specification: {
      "Tên sản phẩm": "Xà bông dược liệu Nghệ",
      "Hình dạng": "Dạng khối, đóng gói trong hộp giấy ",
      "Khối lượng": "100gr",
      "Thể chất": "Khối cứng ",
      "Loại da": "Da thường, da mụn, da dầu ",
